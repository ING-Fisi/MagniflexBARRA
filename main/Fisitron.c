...
void fisitron_mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        msg_id = esp_mqtt_client_publish(client, "/fisitron_topic/log", "data_fisi", 0, 1, 0);
...
void fisitron_mqtt_app_start(void)
{
    ...
    esp_mqtt_client_register_event(mqtt_fisitron, ESP_EVENT_ANY_ID, fisitron_mqtt_event_handler, NULL);
